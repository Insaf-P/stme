<?php
/**
 * STME Elementor Footer Part
 *
 * For use as an Elementor Pro Theme Builder Custom Footer.
 * Go to: Elementor > Theme Builder > Footer > Add New,
 * then import or paste this template, or use it as a reference
 * for building the footer inside the Elementor editor.
 *
 * When used as a Theme Builder part, Elementor renders this
 * file instead of footer.php for the footer location.
 */

if ( ! defined( 'ABSPATH' ) ) exit;
?>
<!-- ===================== ELEMENTOR FOOTER PART ===================== -->
